...
function given_all_files_when_remove_all_mp3-files_and_transcode_then_correct_logfile_and_mp3_filecount {
    ...
    python3 ../transcoder.py --sourcefolder $source --mp3folder $destination --logfolder $root/
    rm -f $root/$log_file
...
function given_all_files_when_remove_all_ogg-files_and_transcode_then_correct_logfile_and_ogg_filecount {
    ...
    python3 ../transcoder.py --sourcefolder $source --oggfolder $destination --logfolder $root/
    rm -f $root/$log_file
...
function given_all_files_when_delete_source_file_then_delete_lossy_file {
    ...
    python3 ../transcoder.py --sourcefolder $source --mp3folder $root/mp3 --oggfolder $root/ogg --logfolder $root/
    rm -f $root/$log_file
...
function given_all_files_when_delete_cover_art_from_a_lossy_tree_and_transcode_then_check_if_copied_cover_art_is_the_same_as_the_source
{
    echo "* ${FUNCNAME[0]}"
    source="$root/flac"
    python3 ../transcoder.py --sourcefolder $source --mp3folder $root/mp3 --logfolder $root/
    rm -f $root/$log_file
